...
def main_menu_kb():
    return InlineKeyboardMarkup([
        [InlineKeyboardButton("⚙️ دستورات تبچیز", callback_data="menu_tabchi"),
         InlineKeyboardButton("🌐 مدیریت همگانی", callback_data="menu_global")],
        [InlineKeyboardButton("🔁 تغییر لایه", callback_data="layers_menu")],
        [InlineKeyboardButton("💳 خرید / تمدید اشتراک", callback_data="buy_plans")],
...
def acc_info_kb(acc_id):
    return InlineKeyboardMarkup([
        ...
        [InlineKeyboardButton("🔧 مدیریت تبچیز", callback_data=f"acc_manage_{acc_id}")],
        [InlineKeyboardButton("🔄 بروزرسانی تبچیزها", callback_data="acc_refresh")],
...
def plans_buy_kb(plans):
    ...
    kb = []
    for pid, name, price, duration_days in plans:
        kb.append([InlineKeyboardButton(
            f"{name} — {price:,} تومان / {duration_days} روز",
...
def pay_method_kb(plan_id):
    return InlineKeyboardMarkup([
        [InlineKeyboardButton("💳 کارت‌به‌کارت (تایید دستی)",
                              callback_data=f"buy_manual_{plan_id}")],
        [InlineKeyboardButton("🌐 پرداخت آنلاین (زرین‌پال)",
                              callback_data=f"buy_zarinpal_{plan_id}")],
        [InlineKeyboardButton("🔙 بازگشت", callback_data="buy_plans")],
    ])


def manual_receipt_kb(plan_id):
    return InlineKeyboardMarkup([
        [InlineKeyboardButton("🔙 انصراف", callback_data="buy_plans")],
    ])


def zarinpal_pay_kb(pay_url):
    return InlineKeyboardMarkup([
        [InlineKeyboardButton("💳 پرداخت در زرین‌پال", url=pay_url)],
        [InlineKeyboardButton("🔙 بازگشت", callback_data="buy_plans")],
    ])
